    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_contract_service_status', 'Может просматривать статус контракта'), ('can_edit_contract_service_status', 'Может редактировать статус контракта')],
            },
        ),
        migrations.CreateModel(
            name='CPDPosition',
            ...
            options={
                ...
                'permissions': [('can_view_cpd_positions', 'Может просматривать должности CPD'), ('can_edit_cpd_positions', 'Может редактировать должности CPD')],
            },
        ),
        migrations.CreateModel(
            name='DBPosition',
            ...
            options={
                ...
                'permissions': [('can_view_db_positions', 'Может просматривать должности DB'), ('can_edit_db_positions', 'Может редактировать должности DB')],
            },
        ),
        migrations.CreateModel(
            name='Department',
            ...
            options={
                ...
                'permissions': [('can_view_departments', 'Может просматривать отделы'), ('can_edit_departments', 'Может редактировать отделы')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_department_staff', 'Может просматривать штаб'), ('can_edit_department_staff', 'Может редактировать штаб')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_important_notifications', 'Может просматривать важную информацию'), ('can_edit_important_notifications', 'Может редактировать важную информацию')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_pa_positions', 'Может просматривать должности ПА'), ('can_edit_pa_positions', 'Может редактировать должности ПА')],
            },
        ),
        migrations.CreateModel(
            name='SEBPosition',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_swat_positions', 'Может просматривать должности SWAT'), ('can_edit_swat_positions', 'Может редактировать должности SWAT')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_roles', 'Может просматривать должности'), ('can_edit_roles', 'Может редактировать должности')],
